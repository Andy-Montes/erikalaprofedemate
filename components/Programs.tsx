    ...
    <section className="py-16 lg:py-24 bg-white scroll-mt-24" id="programas">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-stretch">
          ...
          <div className="lg:w-1/3 flex flex-col p-6 sm:p-8 lg:p-10 bg-slate-50 rounded-[3rem] border-2 border-slate-200 shadow-inner relative">
            ...
            <div className="flex-1 mt-6">
              ...
              <div className="group relative flex flex-col h-full bg-brandNavy p-7 sm:p-9 rounded-[2rem] shadow-xl transition-all duration-500 hover:scale-[1.04] hover:-translate-y-2 hover:shadow-[0_40px_70px_-15px_rgba(31,58,95,0.4)] overflow-hidden border-b-8 border-brandRed">
                <div className="absolute -bottom-10 -right-10 opacity-[0.07] group-hover:opacity-[0.15] group-hover:scale-110 transition-all duration-700 pointer-events-none">
                  <span className="material-symbols-outlined text-[180px] sm:text-[220px] text-white select-none">
                    person
                  </span>
                </div>
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="text-xl font-black mb-4 uppercase tracking-wider text-white leading-tight">
                    Tutoría Individual
                  </h3>
          ...
          {/* ========================= */}
          <div className="lg:w-2/3 flex flex-col p-6 sm:p-8 lg:p-10 bg-blue-100/40 rounded-[3rem] border-2 border-blue-100 shadow-inner relative">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-6">
              ...
              <div className="group relative flex flex-col h-full bg-white p-7 sm:p-9 rounded-[2rem] shadow-xl transition-all duration-500 hover:scale-[1.04] hover:-translate-y-2 hover:shadow-[0_40px_70px_-15px_rgba(0,0,0,0.12)] overflow-hidden border-b-8 border-slate-300">
                <div className="absolute -bottom-10 -right-10 opacity-[0.04] group-hover:opacity-[0.1] group-hover:scale-110 transition-all duration-700 pointer-events-none">
                  <span className="material-symbols-outlined text-[180px] sm:text-[220px] text-brandNavy select-none">
                    groups
                  </span>
                </div>
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="text-xl font-black mb-4 uppercase tracking-wider text-brandNavy leading-tight">
                    Talleres Grupales
                  </h3>
              ...
              <div className="group relative flex flex-col h-full bg-[#0086f2] p-7 sm:p-9 rounded-[2rem] shadow-xl transition-all duration-500 hover:scale-[1.04] hover:-translate-y-2 hover:shadow-[0_40px_70px_-15px_rgba(0,134,242,0.3)] overflow-hidden border-b-8 border-white/40">
                <div className="absolute -bottom-10 -right-10 opacity-[0.1] group-hover:opacity-[0.2] group-hover:scale-110 transition-all duration-700 pointer-events-none">
                  <span className="material-symbols-outlined text-[180px] sm:text-[220px] text-white select-none">
                    school
                  </span>
                </div>
