          ...
          <div className="w-full md:w-[65%]">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-2xl text-slate-400 mt-8 mb-12 leading-relaxed font-light max-w-2xl">
                <span className="text-[#38388d] font-medium">Clases de Matemáticas y preparación PAES</span> <span className="text-brandNavy font-light">enfocadas en cerrar vacíos, eliminar miedo y recuperar la confianza.</span>              </p>
